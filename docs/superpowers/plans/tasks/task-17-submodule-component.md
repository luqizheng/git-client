# Task 17: Submodule — Componente Frontend

> **Fase:** 3 — P2 Útil | **Dependências:** Task 16 (Submodule store)
> **Plano original:** `docs/superpowers/plans/2026-05-17-git-client-features-implementation.md`

**Files:**
- Create: `git-client/src/components/submodule/SubmoduleList.vue`

---

- [ ] **Step 1: Criar SubmoduleList.vue**
